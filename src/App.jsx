    ...
    <HashRouter>
      <div className="app-container">
        ...
        <div className="header">
          ...
          <button>
            <a
              href={`${process.env.PUBLIC_URL}/cv_MarioLimones.pdf`}
              download="cv_MarioLimones"
            >
        ...
        <main className="main-content">
          ...
          <section id="tecnologias" className="section">
            ...
            <p>
              ...
              aplicar una variedad de tecnologías esenciales. Estas herramientas me han capacitado 
              para diseñar, implementar y mantener soluciones sólidas y escalables. A continuación, 
              te presento una lista de las habilidades técnicas que he dominado y utilizado en 
              proyectos reales.
            </p>
            <TechCarousel />
          </section>
